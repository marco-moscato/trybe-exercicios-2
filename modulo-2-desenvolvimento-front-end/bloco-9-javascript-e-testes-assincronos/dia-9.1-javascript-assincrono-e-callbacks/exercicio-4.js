...
const getMarsTemperature = () => {
  ...
  const temperaturaAtual = Math.floor(Math.random() * maxTemperature);
...
const sendMarsTemperature = (getMarsTemperature()) => {
  console.log(`A temperatura de Marte é: ${getMarsTemperature} graus celsius`); // Imprime "A temperatura de Marte é: 20 graus celsius", por exemplo
};
sendMarsTemperature();
